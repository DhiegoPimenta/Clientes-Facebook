<?php
	...
	if( isset($_POST['btn-login']) ) {	
		...
		if(empty($email)){
			...
			$error = true;
			$emailError = "Digite o seu email cadastrado!";
		}
		
		if(empty($pass)){
			$error = true;
			$passError = "Digite sua senha!";
		}
		...
		if (!$error) {
			...
			if( $count == 1 && $row['userPass']==$password ) {
				...
				header("Location: entrou/");
			} else {
				$errMSG = "Ops algo deu errado, tente novamente...";
			}
...
<div class="container">
    ...
    <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" autocomplete="off">
    	...
    	<div class="col-md-12">
            ...
            <div class="form-group">
            <!-- <a href="register.php">Registrar Agora...</a> -->
            </div>
